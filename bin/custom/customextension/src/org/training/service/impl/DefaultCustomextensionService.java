...
public class DefaultCustomextensionService implements CustomextensionService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomextensionService.class);
	...
	{
		return DefaultCustomextensionService.class.getResourceAsStream("/customextension/sap-hybris-platform.png");
	}
